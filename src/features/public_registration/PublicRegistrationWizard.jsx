  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 flex flex-col justify-center items-center font-sans">
      ...
      <div className="w-full max-w-xl text-center mb-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-900 text-xs font-bold uppercase tracking-wider mb-2">
          <Sparkles className="w-3.5 h-3.5 text-amber-600" />
          <span>LPK INDONESIA DIGNITY • OFFICIAL INTAKE</span>
        </div>
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          {step === 1 && (
            <div className="space-y-5 animate-fade-in">
              ...
              <button
                onClick={() => setStep(2)}
                className="w-full py-3 rounded-2xl text-xs font-bold bg-amber-500 hover:bg-amber-400 text-slate-950 transition-all flex items-center justify-center gap-2 shadow-2xs"
              >
